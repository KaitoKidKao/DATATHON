...
\begin{table}[H]
  ...
  \begin{tabular}{llc}
    ...
    \midrule
    \textbf{Absolute Peak} & \textbf{GBDT Ensemble + Objective Diversity + Domain + 5-Seed} & \textbf{\textasciitilde 766,894} \\
    \bottomrule
  \end{tabular}
\end{table}
...
Kiến trúc cuối cùng (\textasciitilde 766K) đạt được trạng thái lý tưởng nhờ giải quyết 3 mặt trận cùng lúc:
\begin{enumerate}
